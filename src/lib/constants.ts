...
export const RAPIDO_PHONE_NUMBER = "+91XXXXXXXXXX"; // ← INSERT REAL NUMBER

export const OTP_CODE = "2408"; // ← The 4-digit OTP to reveal
...
export const LOCATIONS = [
  ...
  },
  {
    ...
    coordinates: { lat: 0.0, lng: 0.0 }, // ← INSERT REAL COORDS
    answer: "bowling",
    alternateAnswers: ["bowling alley", "bowl"],
    mapZoom: 18,
  },
  {
    id: 3,
    name: "Cafe",
    clue: "The aroma of warmth fills the air here. Where conversations flow as smoothly as the drinks. Our favorite corner table is waiting for us, Bubu! ☕",
    coordinates: { lat: 0.0, lng: 0.0 }, // ← INSERT REAL COORDS
    answer: "cafe",
    alternateAnswers: ["coffee", "coffee shop", "café"],
    mapZoom: 18,
  },
];

export const BONUS_SERVICES = [
  "One surprise breakfast in bed (date TBD by Bubu) 🍳",
  ...
  "One free 'I was wrong' — no questions asked 🏳️",
];
